...
contract Ownable {
    ...
    /**
     * Upgrade to v0.8.0+:
     * {Ownable} is replaced by {constructor}.
     */
    constructor() {
        owner = msg.sender;
    }
...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    */
    function transfer(address _to, uint _value) virtual override(ERC20Basic) public onlyPayloadSize(2 * 32) {
...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    */
    function transferFrom(address _from, address _to, uint _value) virtual override(ERC20) public onlyPayloadSize(3 * 32) {
    ...
    */
    function approve(address _spender, uint _value) virtual override(ERC20) public onlyPayloadSize(2 * 32) {
    ...
    */
    function allowance(address _owner, address _spender) virtual override(ERC20) public view returns (uint remaining) {
...
contract TetherToken is Pausable, StandardToken, BlackList {
    ...
    /**
     * Upgrade to v0.8.0+:
     * {TetherToken} is replaced by {constructor}.
     */
    ...
    // Forward ERC20 methods to upgraded contract if this one is deprecated
    function transferFrom(address _from, address _to, uint _value) override(StandardToken) public whenNotPaused {
    ...
    // Forward ERC20 methods to upgraded contract if this one is deprecated
    function approve(address _spender, uint _value) override(StandardToken) public onlyPayloadSize(2 * 32) {
        if (deprecated) {
    ...
    // Forward ERC20 methods to upgraded contract if this one is deprecated
    function allowance(address _owner, address _spender) override(StandardToken) public view returns (uint remaining) {
        if (deprecated) {
